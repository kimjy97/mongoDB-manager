...
import { isAddDocumentModalOpenState, isCopyModalOpenState } from '@/atoms/modal';
...
const AddDocumentModal = () => {
  ...
  const [isModalOpen, setIsModalOpen] = useRecoilState(isAddDocumentModalOpenState);
  const [currentData, setCurrentData] = useState<IDocument>([]);
